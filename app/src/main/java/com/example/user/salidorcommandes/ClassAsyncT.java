...
public class ClassAsyncT extends AsyncTask<String,Void,String> {
    ...
    public ClassAsyncT(CustomListAdapter adpt, ArrayList<Commande> listt, ProgressBar bar ) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            url = new URL("http://salidorcommandes.co.nf/getCommandes.php");

            HttpURLConnection ction = (HttpURLConnection) url.openConnection();

            InputStream inputStream = ction.getInputStream();
        ...
        try {
            ...
            if (data != null) {
                ...
                while (count < jsonarray.length()) {
                    ...
                    list.add(new Commande(titre,text,date));
